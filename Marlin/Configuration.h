...
#define STRING_CONFIG_H_AUTHOR "(Bobbert1220, SKR1.3_BLTouch_2.0.7.3_1)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 186.36
  #define DEFAULT_bedKi 37.25
  #define DEFAULT_bedKd 621.83
...
#define DEFAULT_EJERK    5.0  // May be used by -vance
...
//#define MANUAL_PROBE_START_Z 0.15
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT MANUAL_X_HOME_POS  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT MANUAL_Y_HOME_POS  // Y point for Z homing
#endif
